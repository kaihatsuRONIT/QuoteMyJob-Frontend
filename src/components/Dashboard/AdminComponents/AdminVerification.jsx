                                        ...
                                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                            <thead>
                                                <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
                                                    {['PROFESSIONAL NAME', 'TRADE TYPE', 'CREDENTIALS', 'STATUS', 'ACTION'].map(col => (
                                                        ...
                                                        <td style={{ padding: '14px 16px' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p style={{ fontSize: '11px', color: '#9ca3af', margin: 0 }}>Joined {p.joined}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td style={{ padding: '14px 16px' }}>
                                                            <span style={{ fontSize: '10px', fontWeight: 700, color: p.tradeColor, background: `${p.tradeColor}18`, borderRadius: '6px', padding: '4px 8px', whiteSpace: 'nowrap' }}>
                                                                {p.trade}
                                                            </span>
                                                        </td>
                                                        <td style={{ padding: '14px 16px' }}>
