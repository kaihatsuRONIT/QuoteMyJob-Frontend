        ...
        <div style={{ background: '#fff', padding: '28px 40px 0', fontFamily: 'Work Sans, sans-serif' }}>
            ...
            {activeTab === 'Completed Jobs' ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '24px 40px', fontFamily: 'Work Sans, sans-serif' }}>
                    {jobs.map((job, i) => <JobOrderCard key={i} job={job} />)}
                </div>
            )}
        </div>
    );
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '10px', flexShrink: 0, minWidth: '160px' }}>
                {!isCompleted ? (
                    <>
                        ...
                        <a href='q/5' style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px 16px', borderRadius: '10px', border: 'none', background: '#FF7E00', color: '#fff', fontFamily: 'Manrope, sans-serif', fontWeight: 700, fontSize: '13px', cursor: 'pointer' }}>
                            <FiFileText style={{ fontSize: '13px' }} /> VIEW QUOTES
                        </a>
